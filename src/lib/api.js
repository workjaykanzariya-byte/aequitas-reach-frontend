...
//// ---------- CAMPAIGNS ----------
// Update/replace mockGetCampaigns to include assigneeSummaries + templateCount
...
// Templates list (with campaign IDs that use each template)
